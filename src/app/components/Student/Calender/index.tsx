...
export default function CommunityTabs() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto bg-white rounded-xl shadow-sm p-6 relative overflow-hidden">
      <header className="flex items-center mb-6 relative bg-white">
        <div className="flex items-center gap-3">
          <header className="flex items-center relative bg-white">
            <div className="w-16 h-15 mr-2 rounded-sm overflow-hidden"><Image src="https://i.ibb.co/jJ4GHXP/img1.jpg" alt='imag' width={200} height={100} /></div>
